// Code from Andrei Karpathy's demo - https://github.com/karpathy/recurrentjs
    ...
    var loadModel = function(j) {
      ...
      // was a bug for loading - the model doesn't save out decay_rate and smooth_eps
      solver.decay_rate = 0.999;
      solver.smooth_eps = 1e-8;
      solver.step_cache = {};
    ...
    var tick_iter = 0;
    var tick = function() {
      // sample sentence fromd data - requires data 
      ...
      if(tick_iter % 50 === 0) {
        ...
        for(var q=0;q<5;q++) {
          ...
          // store samples somewhere for use
        }
      }
      if(tick_iter % 10 === 0) {
